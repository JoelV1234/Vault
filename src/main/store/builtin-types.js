...
const BUILTIN_TYPES = [
  ...
  { id: 'project', name: 'Project', icon: 'rocket', color: '#10b981', props: [
  ...
  { id: 'meeting', name: 'Meeting', icon: 'users', color: '#ef4444', props: [
    { id: 'date', name: 'Date', kind: 'date' }, { id: 'attendees', name: 'Attendees', kind: 'relation' }] },
  { id: 'task', name: 'Task', icon: 'check-square', color: '#10b981', props: [
  ...
  { id: 'highlight', name: 'Highlight', icon: 'quote', color: '#ec4899', props: [
    { id: 'source', name: 'Source', kind: 'url' }, { id: 'sourceTitle', name: 'Source title', kind: 'text' }] },
  { id: 'image', name: 'Image', icon: 'image', color: '#14b8a6', props: [{ id: 'source', name: 'Source', kind: 'text' }] },
  { id: 'link', name: 'Link', icon: 'globe', color: '#3b82f6', props: [
